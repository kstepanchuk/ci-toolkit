...
class MyTheme {
  ...
  static const Color accent = Color(0xFF496C54);
  static const Color accent50 = Color(0x77496C54);
  static const Color accent80 = Color(0xAA496C54);
...
Widget loadPowered(BuildContext context) {
  return const SizedBox.shrink(); // SDOdesk: label removed
